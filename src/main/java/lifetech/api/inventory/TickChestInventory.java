package lifetech.api.inventory;
...
public interface TickChestInventory extends Inventory {
    /**
     ...
     */
    static TickChestInventory of(DefaultedList<ItemStack> items) {
        return () -> items;
    }
    /**
     * Creates a new inventory with the size.
     */
    static TickChestInventory ofSize(int size) {
